...
export class Sha3WasmState {
    ...
    __destroy_into_raw() {
        ...
        this.__wbg_ptr = 0;
        Sha3WasmStateFinalization.unregister(this);
        return ptr;
    }
     ...
     */
    is_complete() {
        const ret = wasm.sha3wasmstate_is_complete(this.__wbg_ptr);
        return ret !== 0;
    }
    /**
     * @returns {string}
    ...
    get_current_step_name() {
        ...
        let deferred1_1;
        try {
            const ret = wasm.sha3wasmstate_get_current_step_name(this.__wbg_ptr);
            deferred1_0 = ret[0];
            deferred1_1 = ret[1];
            return getStringFromWasm0(ret[0], ret[1]);
        } finally {
     ...
     */
    get_lane(x, z) {
        const ret = wasm.sha3wasmstate_get_lane(this.__wbg_ptr, x, z);
        return ret;
    }
    /**
     * @returns {number}
...
async function __wbg_init(module_or_path) {
    ...
    if (typeof module_or_path === 'undefined') {
        module_or_path = new URL('sha3_visualizer_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
