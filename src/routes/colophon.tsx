...
export const Route = createFileRoute('/colophon')({
  head: () => ({
    meta: [
      { title: 'Colophon | sandybridge.io' },
      { name: 'description', content: 'How this site is built.' },
    ],
  }),
...
function ColophonPage() {
  return (
    <>
      ...
      <h2>Stack</h2>
      <ul>
        <li><strong>Framework:</strong> TanStack Start with Vite and React 19</li>
        <li><strong>Styling:</strong> Plain CSS with CSS custom properties for theming</li>
        <li><strong>Content:</strong> Markdown/MDX files processed with unified/remark/rehype</li>
      ...
      <p style={{ marginTop: '2rem' }}>
        <Link to="/uses" className="config-link">See my full setup &rarr;</Link>
      </p>
    </>
  )
}
