---
title: "The God That Didn't Show Up"
date: 2026-04-22
description: "A middle finger to AGI, and why the people selling it to you might not get there."
tags: ["ai", "opinion", "sustainability"]
---
...
But there will be an equal weight of negative consequences, and the people making the decisions about how much power to burn and how many ecosystems to flatten aren't weighing those consequences. They can't. The incentive structure doesn't let them. The real driving factor in this race isn't human flourishing, isn't scientific progress, isn't any of the things on the pitch deck. It's investors and billionaires getting extremely fucking rich.
...
So here's my actual prediction. The race ends not with a bang but with a quiet realization. The models get very good, then they plateau. The capex bubble pops. A handful of companies that bet everything on transcendence have to explain to their shareholders why they lit a decade of capital on fire chasing a god that didn't show up. And the rest of us are left with what's actually in our hands — really good tools.
